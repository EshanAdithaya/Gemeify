...
const FEATURED_GEMS = [
  {
    ...
    rating: 5,
    image:
      'https://cdn.shopify.com/s/files/1/0080/0004/5171/products/BS01HMDB_4b2042f1-421e-4024-b814-6bc73855a9c5_350x@2x.jpg?v=1625054014',
    quality: 'AAA',
    certification: 'GIA',
    highlights: ['Natural Blue', 'Heat Treated', 'Ceylon Origin'],
  },
  {
    id: 2,
    name: 'Pink Diamond',
    ...
    rating: 5,
    image:
      'https://media.cnn.com/api/v1/images/stellar/prod/230328171155-01-eternal-pink-diamond.jpg?c=original',
    quality: 'VS1',
    certification: 'GIA',
    highlights: ['Natural Color', 'GIA Certified', 'Argyle Mine'],
  },
  {
    id: 3,
    ...
    quality: 'AAA',
    certification: 'GRS',
    highlights: ['Minor Oil', 'Muzo Mine', 'Rich Green'],
  },
];
...
const CATEGORIES = [
  {
    name: 'Diamonds',
    image:
      'https://5.imimg.com/data5/SELLER/Default/2024/2/382845659/WJ/BP/SL/211079491/diamonds-for-sale.jpg',
    count: '2,534',
  },
  {
    name: 'Rubies',
    image:
      'https://www.latelita.com/cdn/shop/articles/the-ruby-gemstone-everything-you-ever-needed-to-know-about-rubies-748231.jpg?v=1692710601&width=2048',
    count: '1,826',
  },
  {
    name: 'Sapphires',
...
export default function GemifyLanding() {
  ...
  const guarantees = [
    { title: 'Certified Authentic', description: 'Every gem comes with certification from leading gemological laboratories' },
    { title: 'Fair Pricing', description: 'Transparent pricing based on current market values' },
    { title: 'Expert Selection', description: 'Each gem personally selected by our certified gemologists' },
    { title: 'Quality Guarantee', description: '100% satisfaction guaranteed or your money back' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="relative pt-24 pb-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className={`text-lg md:text-xl max-w-2xl mx-auto mb-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
            ...
            <div className="flex justify-center gap-4">
              ...
              <Link
                ...
                className={`px-8 py-3 rounded-lg font-medium ${
                  isDarkMode ? 'bg-white/10 text-white hover:bg-white/20' : 'bg-gray-900/10 text-gray-900 hover:bg-gray-900/20'
                } transition-colors`}
              >
                Learn More
              </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {guarantees.map((guarantee) => (
              <div
                key={guarantee.title}
                className={`${isDarkMode ? 'bg-slate-800/50' : 'bg-white'} rounded-xl p-6 flex flex-col items-center text-center`}
              >
                ...
                <p className={isDarkMode ? 'text-gray-400' : 'text-gray-600'}>{guarantee.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-7xl mx-auto">
          <h2 className={`text-2xl md:text-3xl font-bold mb-8 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
            Featured Investment Gems
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {FEATURED_GEMS.map((gem) => (
              <div
                key={gem.id}
                className={`${isDarkMode ? 'bg-slate-800/50' : 'bg-white'} rounded-xl overflow-hidden hover:transform hover:scale-105 transition-transform shadow-lg`}
              >
                ...
                <div className="p-4">
                  ...
                  <p className={`text-sm mb-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>{gem.description}</p>
                  <div className="space-y-2 mb-4">
                    {gem.highlights.map((highlight) => (
                      <div key={highlight} className="flex items-center">
                        <SparklesIcon className={`w-4 h-4 mr-2 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} />
                        <span className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>{highlight}</span>
                      </div>
                    ))}
                  </div>
      ...
      <div className={`px-4 sm:px-6 lg:px-8 py-16 ${isDarkMode ? 'bg-slate-800/50' : 'bg-gray-50'}`}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className={`space-y-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                <p>
                  Our team of certified gemologists is here to help you make informed investment decisions. With
                  decades of experience in the industry, we provide:
                </p>
                <ul className="space-y-3">
                  <li className="flex items-center">
                    <Shield className={`w-5 h-5 mr-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} />
                    Detailed gem analysis and authenticity verification
                  </li>
                  <li className="flex items-center">
                    <SparklesIcon className={`w-5 h-5 mr-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} />
                    Investment potential assessment
                  </li>
                  <li className="flex items-center">
                    <Eye className={`w-5 h-5 mr-3 ${isDarkMode ? 'text-purple-400' : 'text-purple-600'}`} />
              ...
              <div className="mt-8 flex gap-4">
                ...
                <Link
                  ...
                  className={`px-6 py-3 rounded-lg font-medium border ${
                    isDarkMode ? 'border-gray-700 text-white hover:bg-white/10' : 'border-gray-300 text-gray-900 hover:bg-gray-100'
                  } transition-colors`}
                >
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { Icon: ScaleIcon, title: 'Value Appreciation', text: 'Historical track record of steady value growth, especially for rare gems' },
              { Icon: Shield, title: 'Tangible Asset', text: 'Physical ownership of beautiful and portable wealth' },
              { Icon: SparklesIcon, title: 'Portfolio Diversity', text: 'Alternative investment uncorrelated with traditional markets' },
            ].map(({ Icon, title, text }) => (
              <div key={title} className={`p-6 rounded-xl ${isDarkMode ? 'bg-slate-800/50' : 'bg-white shadow-lg'}`}>
                <div
